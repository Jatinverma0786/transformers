...
class Quatfit1VideoProcessorKwargs(VideosKwargs, total=False):
    """
...
# Copied from transformers.models.quatfit1.image_processing_quatfit1.get_aspect_ratio_preserving_size
...
@add_start_docstrings(
    "Constructs a Quatfit1 video processor that samples frames from videos for use with the Quatfit1 model.",
    BASE_VIDEO_PROCESSOR_DOCSTRING,
)
class Quatfit1VideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = Quatfit1VideoProcessorKwargs
    model_input_names = ["pixel_values_videos", "video_position_ids"]

    def __init__(self, **kwargs: Unpack[Quatfit1VideoProcessorKwargs]):
    ...
    def preprocess(
        self,
        videos: VideoInput,
        **kwargs: Unpack[Quatfit1VideoProcessorKwargs],
    ) -> BatchFeature:
...
__all__ = ["Quatfit1VideoProcessor"]
